...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_F9_PASTE]     = ACTION_TAP_DANCE_DOUBLE(KC_F9, C(KC_V)),
    [TD_F10_HUEON]     = ACTION_TAP_DANCE_DOUBLE(KC_F10, S(G(KC_1))),
    [TD_F11_HUESYNC]   = ACTION_TAP_DANCE_DOUBLE(KC_F11, S(G(KC_2))),
    [TD_F12_TERMINAL]   = ACTION_TAP_DANCE_DOUBLE(KC_F9, C(A(KC_T)))
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        TD(TD_F10_HUEON),   TD(TD_F11_HUESYNC),   TD(TD_F12_TERMINAL)
    ),
