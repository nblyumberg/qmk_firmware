...
[_LOWER] = LAYOUT_ortho_5x12( \
  ...
  _______,    KC_LEFT,   KC_UP  ,       KC_DOWN,   KC_RIGHT,   LSFT(KC_9),  LSFT(KC_0),   KC_UNDS,      KC_PLUS,     KC_LCBR,    KC_RCBR,   KC_PIPE, \
...
[_FUN] = LAYOUT_ortho_5x12( \
  ...
  _______,     _______,     _______,      _______,      _______,      _______,    _______,      _______,      _______,      _______,      _______,     _______, \
  _______,     _______,     _______,      _______,      _______,      KC_F18,    _______,      _______,      _______,      _______,      _______,     _______  \
)
};
